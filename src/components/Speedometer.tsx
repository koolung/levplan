    ...
    <div className="flex flex-col items-center justify-center my-12">
      ...
      <div className="meter">
        <svg width="327" height="317" id="meter" viewBox="0 0 327 317" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="14" y="9" width="301" height="202" fill="#002349" />
        ...
        <svg width="30" height="144" id="needle" viewBox="0 0 30 144" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="15.2089" cy="128.608" r="10.9086" fill="white" stroke="#b77700ff" strokeWidth="7" />
          ...
          <defs>
            <linearGradient id="paint0_linear_498_1180" x1="8.57715" y1="129.079" x2="18.8019" y2="129.199" gradientUnits="userSpaceOnUse">
              <stop offset="0.6874" stopColor="#ffc250ff" />
              <stop offset="0.6875" stopColor="#e7a832" />
            </linearGradient>
          </defs>
        </svg>
      ...
      <div className="text-center -mt-24 relative z-20">
        <div className={`inline-block px-4 py-1 border-2 ${colors.border} `}>
